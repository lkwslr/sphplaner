...
Future<void> main() async {
  ...
  Logger.root.onLevelChanged.listen((event) {
    Fluttertoast.showToast(msg: event?.name == "ALL"
        ? "Debug Modus aktiviert"
        : "Debug Modus deaktiviert", toastLength: Toast.LENGTH_SHORT);
  });
                          ...
                          bottomNavigationBar: NavigationBar(
                            ...
                            destinations: <Widget>[
                              NavigationDestination(selectedIcon: Icon(
                                  Icons.calendar_view_day, color: Theme
                                  .of(context)
                                  .colorScheme
                                  .onPrimary),
                                icon: const Icon(
                              ...
                              NavigationDestination(selectedIcon: Icon(
                                Icons.calendar_month, color: Theme
                                  .of(context)
                                  .colorScheme
                                  .onPrimary,),
                              ...
                              NavigationDestination(
                                selectedIcon: Icon(Icons.book, color: Theme
                                    .of(context)
                                    .colorScheme
                                    .onPrimary,),
