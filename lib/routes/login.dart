...
class _LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(appBar: AppBar(title: const Text("Anmelden am SPH"),),
            ...
            children: [
              ...
              SingleChildScrollView(child: Padding(
                  ...
                  child: Center(child: SizedBox(
                    ...
                    child: getForm(logicalScreenSize.width / 2, min(
                        max(40.0, logicalScreenSize.height / 12), 64.0),
                        true),),)))
            ],);
        }
      }),);
  ...
  Form getForm(width, buttonHeight, bool landscape) {
    return Form(key: _formKey,
      child: SingleChildScrollView(child: SizedBox(
        width: width, child: Column(mainAxisAlignment: MainAxisAlignment.center,
        children: [
          const Text(
                ...
                return TextFormField(controller: textEditingController,
                  ...
                  decoration: InputDecoration(labelText: 'Schule',
                      ...
                      focusedBorder: OutlineInputBorder(borderSide: BorderSide(
                          color: schooldId != "" ? Colors.green : Theme
                              .of(context)
                              .colorScheme
                              .primary, width: 2))),
                  focusNode: focusNode,
          ...
          Padding(padding: const EdgeInsets.symmetric(vertical: 8),
            child: TextFormField(autofillHints: const [AutofillHints.username],
          ...
          Text(errormessage),
          if (errormessage != "")TextButton(onPressed: () {
          ...
          Padding(padding: const EdgeInsets.symmetric(vertical: 16.0),
            child: ElevatedButton(onPressed: _loading ? null : () async {
              ...
              if (_formKey.currentState!.validate()) {
                ...
                String returnvalue = await sphLogin(schooldId);

                _wrongData = returnvalue != "true";
                if (!_wrongData) {
                  ...
                  if (returnvalue.startsWith("ERROR")) {
                    errormessage = returnvalue.split("=")[1];
                  }
                  setState(() {
                    info = "Anmelden";
                    _loading = false;
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  backgroundColor: Theme
                      ...
                      .colorScheme
                      .primary,),
                child: Text(info, style: TextStyle(color: Theme
                    .of(context)
                    .colorScheme
                    .onPrimary),)),),
        ],),)),);
  ...
  Future<String> sphLogin(String schoolId) async {
    setState(() {
  ...
  Route _createRoute() {
    return PageRouteBuilder(pageBuilder: (context, animation,
        secondaryAnimation) => const SPHPlaner(),
