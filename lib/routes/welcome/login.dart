...
class _LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(appBar: AppBar(title: const Text("SPH Planer"),),
        body: PropertyChangeConsumer<StorageNotifier, String>(
            properties: const ['main'], builder: (context, notify, _) {
          return OrientationBuilder(builder: (context, _) {
            Size logicalScreenSize = View
                .of(context)
                .physicalSize / View
                .of(context)
                .devicePixelRatio;
              ...
              return Stack(fit: StackFit.expand,
                children: [
                  ImageFiltered(
                    ...
                    child: Image.asset(
                      'assets/sph_extra-wide.png', fit: BoxFit.fitWidth,),),
                  Container(
                    decoration: BoxDecoration(gradient: LinearGradient(colors: [
                      ...
                      Theme
                          ...
                          .background
                          .withOpacity(.5)
                    ], begin: Alignment.topCenter, end: const Alignment(
                        0, 1))),),
                  SingleChildScrollView(child: Padding(padding: const EdgeInsets
                      .all(16.0), child: Center(child: SizedBox(
                    width: logicalScreenSize.width / 2,
                    child: getForm(logicalScreenSize.width / 2,
  ...
  Form getForm(width, buttonHeight, bool landscape, StorageNotifier notify) {
    return Form(key: _formKey,
      child: SingleChildScrollView(child: SizedBox(width: width,
          ...
          children: [
              ...
              child: Autocomplete<School>(
                optionsBuilder: (TextEditingValue textEditingValue) {
                  if (textEditingValue.text.isEmpty) {
                    ...
                    return schoolOptions!.where((School school) {
                      ...
                      bool contains = true;
                      for (String word in textEditingValue.text.toLowerCase()
                          .split(" ")) {
                    ...
                    return schoolOptions!.where((School school) => school.name
                ...
                fieldViewBuilder: (BuildContext context,
                  ...
                  return TextFormField(controller: textEditingController,
                    ...
                    decoration: InputDecoration(labelText: 'Schule',
                        hintText: "Tippe, um deine Schule auszuwählen.",
                        border: const OutlineInputBorder(),
                        focusedBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                                color: schoolId != "" ? Colors.green : Theme
                                    .of(context)
                                    .colorScheme
                                    .primary, width: 2))),
                    focusNode: focusNode,
                    ...
                    onChanged: (String value) {
                      if ((value.length == 4 || value.length == 5) && int
                          .tryParse(value) != null) {
                        setState(() {
                          schoolId = value;
                        });
            ...
            Padding(padding: const EdgeInsets.symmetric(vertical: 8),
              child: TextFormField(decoration: InputDecoration(
                  labelText: 'Passwort', suffixIcon: GestureDetector(onTap: () {
                setState(() {
                  obscure = !obscure;
                });
              }, child: Icon(Icons.remove_red_eye, color: obscure ? null : Theme
                  .of(context)
                  .colorScheme
                  .primary),)),
                keyboardType: TextInputType.text,
            ...
            Padding(padding: const EdgeInsets.symmetric(vertical: 16.0),
              child: ElevatedButton(onPressed: _loading ? null : () async {
                _wrongData = false;
                if (_formKey.currentState!.validate()) {
                  ...
                  if (username == "TESTUSER") {
                    ...
                    SPH.setCredetials(username, password, int.parse(schoolId));

                    try {
                      String sid = await SPH.getSID();
                      StorageProvider.saveCredentials(username, password);
                      String userID = "";
                      try {
                      ...
                      if (userID != "") {
                        ...
                        await SPH.update(notify).then((value) {
                          Navigator.pushReplacement(context, MaterialPageRoute(
                              builder: (context) => const LoginSettings()));
                        });
                      }
                    } catch (error) {
                      errormessage = error.toString().substring(6);
                    }
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    backgroundColor: Theme
                        ...
                        .primary,),
                  child: Text(
                    StorageProvider.settings.updateLock ? StorageProvider
                        .settings.updateLockText : info,
